...
function startSlideshow(interval) {
  ...
  if (interval > 0) {
    const wallpapers = [
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="150" viewBox="0 0 200 150"><rect width="200" height="150" fill="%231a1a2e"/></svg>',
      // ... больше обоев
    ];
    let idx = 0;
...
// Скриншот (простой, без html2canvas)
function takeScreenshot() {
  kernel.showNotification('Скриншот временно недоступен (демо)');
}
